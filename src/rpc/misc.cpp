...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"thought\" activates all Thought-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "thought")
            + HelpExampleRpc("debug", "thought+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given thought address.\n"
            ...
            "\nArguments:\n"
            "1. \"address\"                    (string, required) The thought address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The thought address validated\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The thought address to use for the signature.\n"
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in notions\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in notions\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in notions\n"
            "  \"received\": xxxxx              (numeric) The total number of notions received (including change)\n"
            "}\n"
            "\nExamples:\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "thought-cli and the GUI. There is no server-side difference."
        );
...
static UniValue getinfo_deprecated(const JSONRPCRequest& request)
{
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
        ...
        "\nthought-cli has the option -getinfo to collect and format these in the old format."
    );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Thought features */
    { "thought",               "mnsync",                 &mnsync,                 {} },
    { "thought",               "spork",                  &spork,                  {"arg0","value"} },
