...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ThoughtUnits::SeparatorStyle separators=ThoughtUnits::separatorStandard) const;
...
#endif // THOUGHT_QT_TRANSACTIONTABLEMODEL_H
