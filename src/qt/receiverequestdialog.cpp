...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatThoughtURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ThoughtUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatThoughtURI(info));
}
