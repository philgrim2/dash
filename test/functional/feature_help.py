...
"""Verify that starting thoughtd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start thoughtd with -h for help text")
        ...
        self.log.info("Start thoughtd with -version for version information")
