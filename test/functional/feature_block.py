...
class FullBlockTest(ThoughtTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure thoughtd isn't accepting b26
        ...
        # Extend the b28 chain to make sure thoughtd isn't accepting b28
        ...
        # thoughtd doesn't disconnect us for sending a bloated block, but if we subsequently
